        ...
        if (!IsPostBack)
        {
            try
            {
                ...
                //{
                    ...
                    String all = "SELECT Projects.*, ProjectSalesCycleStage.DateCreated as StageDate Company.Name as CompanyName FROM Projects, ProjectSalesCycleStage  INNER JOIN Company ON Projects.Company = Company.Id";
