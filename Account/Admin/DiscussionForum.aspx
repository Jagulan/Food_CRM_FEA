<%@ Page Title="Discussion Forum :: FEA" Language="C#" MasterPageFile="~/Account/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="DiscussionForum.aspx.cs" Inherits="student_Subject" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div id="page-wrapper">
        <div class="main-page signup-page">
            <h3 class="title1">Discussion Forum</h3>
                                        ...
                                        <div class="position-center">
                                            <div class="form-group">
                                                <asp:Repeater ID="r1" runat="server">
                                                    <ItemTemplate>
                                                        <p style="font-size: 40px; color: #000000">Project Name: <%# Eval("ProjectName") %></p>
                                                        <p style="color: #808080; font-size: 20px">Company Name: <%# Eval("CompanyName") %></p>
                                                        <p style="color: #808080; font-size: 20px">Stage Name: <%# Eval("StageName") %></p>
                                                        <br />
                                                    </ItemTemplate>
                                                </asp:Repeater>
