...
public partial class Purchase : System.Web.UI.Page
{
    ...
    {
        String all = "SELECT Contacts.*, Company.Name as CompanyName FROM Contacts INNER JOIN Company ON Contacts.Company = Company.Id  where Company.Id = '"+ Request.QueryString["CompanyId"] + "'";
    ...
    protected void Order_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        if (e.CommandName == "delete")
        {
            ...
            SqlCommand cmd = new SqlCommand("delete from Contacts where Id = @Id", c);
