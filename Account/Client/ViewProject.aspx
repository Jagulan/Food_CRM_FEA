<%@ Page Title="View Project :: FEA" Language="C#" MasterPageFile="~/Account/Client/MasterPage.master" AutoEventWireup="true" CodeFile="ViewProject.aspx.cs" Inherits="Purchase" %>
                                        ...
                                        <table class="nav-justified">
                                            <tr>
                                                <td>
                                                    ...
                                                    <a>
                                                    <asp:Label ID="lblAnn" runat="server" Text='<%# Eval("Name") %>' CssClass="auto-style2" /> | Milestone Last Deadline: 
