...
public partial class Purchase : System.Web.UI.Page
{
    ...
    private void BindRepeater()
    {
        ...
        String all = "SELECT Projects.*, Company.Name as CompanyName FROM Projects INNER JOIN Company ON Projects.Company = Company.Id";
    ...
    protected void btnAddClasses_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            SqlCommand cmd = new SqlCommand("insert into Projects values('" + guid + "', '" + DateTime.Today.ToShortDateString() + "', '" + txtName.Value + "', '" + txtDesc.Value + "', '" + ddlCompany.SelectedValue + "', 'Cycle Not Yet Started')", c, trans);
            cmd.ExecuteNonQuery();
