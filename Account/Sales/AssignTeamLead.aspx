<%@ Page Title="Assign Team Lead :: FEA" Language="C#" MasterPageFile="~/Account/Sales/MasterPage.master" AutoEventWireup="true" CodeFile="AssignTeamLead.aspx.cs" Inherits="Purchase" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div id="page-wrapper">
        <div class="main-page signup-page">
            <h3 class="title1">Assign Team Lead
            </h3>
                            ...
                            <table class="table table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Team Lead Email<br />
                                            &nbsp;</th>
                                        <th>Team Lead Name<br />
                                            &nbsp;</th>
                                        <th>Delete<br />
                                            &nbsp;</th>
                                    </tr>
