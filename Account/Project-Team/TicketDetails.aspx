<%@ Page Title="Ticket Details :: FEA" Language="C#" MasterPageFile="~/Account/Project-Team/MasterPage.master" AutoEventWireup="true" CodeFile="TicketDetails.aspx.cs" Inherits="Purchase" %>
            ...
            <div class="sign-up-row widget-shadow">
                ...
                <div class="form-body" data-example-id="simple-form-inline">
                    <asp:Repeater ID="r1" runat="server">
                        <ItemTemplate>
                            ...
                            <div class="col-md-6" style="text-align: right">
                                <a href="RaiseTicket.aspx?ProjectId=<%# Eval("ProjectId")%>" class="btn btn-default" />Raise Tickets</a>

                                &nbsp;|&nbsp;
                                <a href="ViewProject.aspx?ProjectId=<%# Eval("ProjectId")%>" class="btn btn-primary" />Project Details</a>
                                >
                                <a href="Ticket.aspx?ProjectId=<%# Eval("ProjectId")%>" class="btn btn-success" />Tickets</a>
                            </div>

                            <div class="col-md-12" style="text-align: left; font-size: x-large">
                                <br />
                                <b>Priority : </b><%# Eval("Priority")%>
                            </div>
                            <br />
                            <br />
                            <p>
                            ...
                            <div class="col-md-6" style="text-align: left">
                                <b>Ticket Name: </b><%# Eval("Name")%><br />
                                <br />

                            </div>
                            <div class="col-md-6" style="text-align: left">
                                <b>Raised On: </b><%# Eval("DateCreated")%><br />
                                <b>Raised By: </b><%# Eval("RaisedByName")%> ( <%# Eval("RaisedBy")%> )
                            </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-6">
                            <asp:Label runat="server" ID="lblStatus" Text="" Font-Bold="true" ForeColor="Red"></asp:Label>
                            <asp:Button runat="server" Text="Close the ticket" OnClick="btnCloseTickets_Click" ID="btnCloseTickets" ValidationGroup="q1" class="btn btn-success" />
                        </div>
                        <br />
                        <br />
                        <hr />
                                                        ...
                                                        <table class="nav-justified">
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <asp:Repeater ID="DiscussionImage" runat="server">
                                                                        <ItemTemplate>
                                                                            <br />
                                                                            <br />
                                                                            <img class="img-responsive" src='data:Images/jpg;base64,<%# Eval("DiscussionImage") != System.DBNull.Value ? Convert.ToBase64String((byte[])Eval("DiscussionImage")) : string.Empty %>' alt="image" style="height: 200px; width: 400px;" />
                                                                        </ItemTemplate>
                                                                    </asp:Repeater>
                                                                </td>
                                                            </tr>
